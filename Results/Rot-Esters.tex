...
\begin{figure}
  \caption{Потенциалы внутреннего вращения аналогов сложных эфиров\label{fig:Internal:Rotation:Esters} [переделать координаты, чтобы угол был \ce{H3C-C-Y-CH3}, иначе тут всё слева неправильно, а сам торсионный угол тут \ce{X=C-Y-CH3}]}
  \centerfloat{
    \begin{tikzpicture}
