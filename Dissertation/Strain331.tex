...
\label{tab:Cycle:Six:Opt:Begin}\begin{longtabu} to \textwidth {cr|SS|X[l]}
  ...
  %\small
  \toprule
  \multicolumn{2}{c|}{\label{tab:Cycle:Six:Opt} Структура}  & \(E_{2}\),~\si{\hartree} & \(E_{ZPE}\),~\si{\hartree} & Геометрия \endfirsthead
  \multicolumn{5}{p{\textwidth}}{\emph{продолжение таблицы}~\arabic{table}} \\
  ...
  \bottomrule\multicolumn{5}{l}{} \endlastfoot
  \midrule\chemfig{?-[:+160]-[:-120]<[:+20]-[:-20,,,,line width=\boldbondwidth]>[:+60]?} / \SymGroup{D}{3d} & \cmpd{Cyclohexane} & \num{-235.344605} & \num{0.171358}& \ce{C-C}~\SI{1.526}{\angstrom}; $\angle$\ce{CCC}~\ang{110.7}; $\tau=\pm\ang{56.9}$ \\  \bottomrule
\multicolumn{5}{l}{\emph{Симметричные производные}~(\ce{X}=\ce{Y},~\SymGroup{C}{2h}) } \\
  \toprule\chemfig{?-[:+160]-[:-120]O<[:+20]-[:-20,,,,line width=\boldbondwidth]>[:+60]O?} / \SymGroup{C}{2h} & \cmpd{Dioxane14} & & & \ce{C-C} \\
  ...
  \midrule
  \multicolumn{5}{l}{\emph{Несимметричные производные}~(\ce{X}$\ne$\ce{Y},~\SymGroup{C}{s}) } \\
  \toprule\chemfig{?-[:+160]-[:-120]O<[:+20]-[:-20,,,,line width=\boldbondwidth]>[:+60]?} / \SymGroup{C}{s} & \cmpd{Pyran} & & & \ce{C-C} \\
