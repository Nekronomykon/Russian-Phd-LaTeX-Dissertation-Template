...
\begin{tikzpicture}
  \begin{axis} [%
    ...
    xmin=-180, xmax=180,
    xtick={-180,-120,...,180},
    ylabel={$\Delta\Func{E}$,~\si{\kilo\joule\per\mole}}, ymin=-1, ymax=27
    ]
    \addplot [black,thick,smooth,domain=-180:180] table [x=Tau,y=Erel] {Results/ScanButane.save.dat};
    \addplot [red,thick,smooth,domain=-180:180] table [x=Tau,y=Erel] {Results/ScanMeOEt.save.dat};
    \addplot [brown,thick,smooth,domain=-180:180] table [x=Tau,y=Erel] {Results/ScanMeSEt.save.dat};
    \addplot [green,thick,smooth,domain=-180:180] table [x=Tau,y=Erel] {Results/ScanMeCOEt.save.dat};
  \end{axis}
\end{tikzpicture}%
...
\begin{tikzpicture}
  \begin{axis} [%
    %title={\chemfig{H_3C-[:+30]\circ-[:-30]\bullet(-[:-90]CH_3)-[:+30]CH_3}},
...
\addplot [black,thick,smooth,domain=-180:180] table [x=Tau,y=Erel] {Results/ScanIsopentane.save.dat};
\addplot [red,thick,smooth,domain=-180:180] table [x=Tau,y=Erel] {Results/ScanIPrOMe.save.dat};
%\addplot [brown,thick,smooth,domain=-180:180, domain y=-1:27] table [x=Tau,y=Erel] {Results/ScanIPrSMe.save.dat};
