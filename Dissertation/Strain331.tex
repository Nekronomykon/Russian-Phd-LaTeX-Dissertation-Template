...
\begin{longtabu} to \textwidth {rr|SS|X[l]}
\multicolumn{5}{p{\textwidth}}{Таблица\label{tab:Cycle:Six:Opt}~\arabic{table}. Строение аналогов циклогексана} \\ %  
\toprule\multicolumn{2}{c|}{\label{tab:Cycle:Six:Opt} Структура}  & \(E_{2}\),~\si{\hartree} & \(E_{ZPE}\),~\si{\hartree} & Геометрия \endfirsthead
  \multicolumn{5}{p{\textwidth}}{\emph{продолжение таблицы}~\arabic{table}:} \\
