...
За исключением простейших структур, молекулы реагентов также обладают конформационной подвижностью. В частности, инверсия атома азота триметиламина~\cmpd{Trimethylamine} взаимодействует со внутренним вращением метильных групп. Внутреннее вращение \emph{н}-бутана~\cmpd{Butane} и его аналогов\dots
...
\pgfplotstablesave[columns={Tau,Etot,Erel}]{\ScanMeOEt}{Results/ScanMeSEt.save.dat}
...
\pgfplotstablesave[columns={Tau,Etot,Erel}]{\ScanIPrOMe}{Results/ScanIPrOMe.save.dat}

%\begin{tikzpicture}
%\begin{axis}[xlabel=$\tau$,ylabel=$\Delta\Func{E}$% table
%\addplot table[x=Tau,y=Erel,]{Results/ScanButane.save.dat};
%\end{axis}
%\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{axis}[
    %title={Внутреннее вращение},
    xlabel={\chemfig{H_3C-[:+30]\circ-[:-30]\circ-[:+30]CH_3}}, xmin=-180, xmax=180,
    ylabel={$\Delta\Func{E}$}, ymin=-0.5, ymax=27.5
    ]
    \addplot [black,thick,smooth,domain=-180:180%, domain y=-0.5:27.5] 
    ] table [x=Tau,y=Erel] {Results/ScanButane.save.dat};
    \addplot [red,thick,dotted,smooth,domain=-180:180, domain y=-1:27] table [x=Tau,y=Erel] {Results/ScanMeOEt.save.dat};
    \addplot [yellow,thick,dashed,smooth,domain=-180:180, domain y=-1:27] table [x=Tau,y=Erel] {Results/ScanMeSEt.save.dat};
    \addplot [green,thick,smooth,domain=-180:180, domain y=-1:27] table [x=Tau,y=Erel] {Results/ScanMeCOEt.save.dat};
  \end{axis}
\end{tikzpicture}
\caption{\label{fig:Internal:Rotation:Butanes}Потенциалы внутреннего вращения молекул \cmpd{Butane}--\cmpd{Butanone}}
\end{figure}
...
\begin{tikzpicture}
  \begin{axis}[
    xlabel={\chemfig{H_3C-[:+30]\circ-[:-30]\bullet(-[:-90]CH_3)-[:+30]CH_3}}, xmin=-180, xmax=180,
ylabel={$\Delta\Func{E}$}, ymin=-0.5, ymax=27.5
]
\addplot [black,thick,smooth,domain=-180:180%, domain y=-0.5:27.5] 
] table [x=Tau,y=Erel] {Results/ScanIsopentane.save.dat};
\addplot [red,thick,dotted,smooth,domain=-180:180, domain y=-1:27] table [x=Tau,y=Erel] {Results/ScanIPrOMe.save.dat};
%\addplot [yellow,thick,dashed,smooth,domain=-180:180, domain y=-1:27] table [x=Tau,y=Erel] {Results/ScanIPrSMe.save.dat};
%\addplot [blue,thick,smooth,domain=-180:180, domain y=-1:27] table [x=Tau,y=Erel] {Results/ScanMeMeNEt.save.dat};
\end{axis}
\end{tikzpicture}
\caption{\label{fig:Internal:Rotation:Isopentanes}Потенциалы внутреннего вращения молекул \cmpd{Isopentane}--\cmpd{Me2NEt}}
\end{figure}

\begin{table}
\caption{\label{tab:InternalRotation:Butane}Внутреннее вращение молекулы \emph{н}-бутана~\cmpd{Butane}, MP2/aug-cc-pVTZ}
\pgfplotstabletypeset[column type=r,columns={Tau,Etot,Erel}]\ScanButane
\end{table}

\begin{table}
\caption{\label{tab:InternalRotation:MeOEt}Внутреннее вращение молекулы метиэтилового эфира~\cmpd{MeOEt}, MP2/aug-cc-pVTZ}
\pgfplotstabletypeset[column type=r,columns={Tau,Etot,Erel}]\ScanMeOEt
\end{table}

\begin{table}
\caption{\label{tab:InternalRotation:MeSEt}Внутреннее вращение молекулы метилэтилсульфида~\cmpd{MeSEt}, MP2/aug-cc-pVTZ}
\pgfplotstabletypeset[column type=r,columns={Tau,Etot,Erel}]\ScanMeSEt
\end{table}

\begin{table}
\caption{\label{tab:InternalRotation:Butanone}Внутреннее вращение молекулы бутанона-2~\cmpd{Butanone}, MP2/aug-cc-pVTZ}
\pgfplotstabletypeset[column type=r,columns={Tau,Etot,Erel}]\ScanMeCOEt
\end{table}

\begin{table}
\caption{\label{tab:InternalRotation:Isopentane}Внутреннее вращение молекулы изопентана~\cmpd{Isopentane}, MP2/aug-cc-pVTZ}
\pgfplotstabletypeset[column type=r,columns={Tau,Etot,Erel}]\ScanIsoPentane
\end{table}

\begin{table}
  \caption{\label{tab:InternalRotation:Me2NEt}Внутреннее вращение молекулы \ce{N},\ce{N}-диметилэтиламина~\cmpd{Me2NEt}, MP2/aug-cc-pVTZ}
\end{table}

\begin{table}
\caption{\label{tab:InternalRotation:Me2CHOMe}Внутреннее вращение молекулы метил-\emph{изо}-пропилового эфира~\cmpd{Me2CHOMe}, MP2/aug-cc-pVTZ}
\pgfplotstabletypeset[column type=r,columns={Tau,Etot,Erel}]\ScanIPrOMe
\end{table}

\begin{table}
\caption{\label{tab:InternalRotation:Me2CHSMe}Внутреннее вращение молекулы метил-\emph{изо}-пропилсульфида~\cmpd{Me2CHSMe}, MP2/aug-cc-pVTZ}
\end{table}
