...
\begin{tikzpicture}
  ...
  \end{axis}
\end{tikzpicture}%
\caption{\label{fig:Internal:Rotation:Butanes}Потенциалы внутреннего вращения молекул \cmpd{Butane}--\cmpd{Butanone}~(легенда???)}
\end{figure}
...
\end{axis}
\end{tikzpicture}%
\caption{\label{fig:Internal:Rotation:Isopentanes}Потенциалы внутреннего вращения молекул \cmpd{Isopentane}--\cmpd{Me2NEt}~(легенда???)}
\end{figure}
