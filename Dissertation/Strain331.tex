...
%%
\pgfplotstablecreatecol[%
\pgfmathsetmacro{\minvalue}{-158.084303}
create col/assign/.code={%
\pgfkeyslet{/pgfplots/table/create col/next content}{{\getthisrow{Etot} - \minvalue} * \AUtoKJM}%
}]{Erel}{\ScanButane} 
%
\pgfplotstabletypeset[column type=r,columns={Tau,Etot,Erel}
]
\ScanButane
