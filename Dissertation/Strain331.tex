...
\multicolumn{5}{p{\textwidth}}{Таблица\label{tab:Reagents:Opt}~\arabic{table}. Строение молекул-реагентов для реакций разделения связей по данным неэмпирических расчётов} \\ %
...
\midrule \begin{tabular}{c} \chemfig{H_3C-[:-30]N(-[:-90]CH_3)-[:+30]-[:-30]CH_3} \\ \cmpd{Me2NEt} \end{tabular} & & & & \\
...
\begin{figure}
\caption{Потенциалы внутреннего вращения молекул \label{fig:Internal:Rotation:Esters}}
\centerfloat{
\begin{tikzpicture}
