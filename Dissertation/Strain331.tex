...
\begin{tikzpicture}
  ...
  \end{axis}
\end{tikzpicture}%
\label{fig:Internal:Rotation:Butanes}

%\caption{Потенциалы внутреннего вращения молекул \cmpd{Butane}--\cmpd{Butanone}}
\end{center}
...
\end{axis}
\end{tikzpicture}%
\label{fig:Internal:Rotation:Isopentanes}

%\caption{Потенциалы внутреннего вращения молекул \cmpd{Isopentane}--\cmpd{Me2NEt}} 
\end{center}
