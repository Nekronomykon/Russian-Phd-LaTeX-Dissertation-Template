...
\begin{longtabu} to \textwidth {c|c|SS|S|X[l]}
  ...
  \midrule
  \cmpd{Bicycle331} & \BC{}~\(\SymGroup{C}{s}\) & -351.821711 & & \num{0.117} & \\
  \chemfig{[:-30,0.75]*6(-(-[:180]-[:120]-[:+60]-[:0]?)-----)} & \CC{}~\(\SymGroup{C}{2}\) & & & & \\
  & \TT{}~\(\SymGroup{C}{2}\) & & & & \\
  \midrule
...
\begin{table}
  \caption{Ещё одна иллюстрация конформационного поведение аналогов бицикло[3.3.1]нонана}\label{fig:Conformational:Behavior:331:XYZ}
  \centerfloat{
