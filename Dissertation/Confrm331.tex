...
\begin{figure*}
  \caption{Конформационная энергия для симметричного гетероаналогичного замещения,~ккал/моль (расчёт MP4(2)/aug-cc-pVDZ + ZPE)~\cite{Pisarev:2013:rus,Pisarev:2013}\label{fig:Conform331:MP2}}
  \centering
