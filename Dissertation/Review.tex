...
\vspace{\medskipamount}
\caption{\label{fig:System331:379XYZ:Conf}Основные конформации  бицикло[3.3.1]нонана и его 3X,~7Y,~9Z-аналогов}
\end{figure}
...
Псевдопеллетьерин (9-метил-9-азабицикло[3.3.1]нонанон-3)~\cmpd{Pseudopelletierine} 
\cite{VallejoLopez:2017} и скопин (9-метил-3-окса-9-азабицикло[$3.3.1.0^{2,4}$]нонанол-7)~\cmpd{Scopine}
\begin{center}
  \begin{tabular}{cc}
\chemfig{[:-30]N*6((-[:0,0.75]CH_3)-?----(-[:180]-[:-120]C(=[:180,0.75]O)-[:-60]?)-)} & \chemfig{[:-30]N*6((-[:0,0.5]CH_3)>?[a]-?[b]<O>(?[b])-(-[:180]-[:-120](<:[:180,0.75]HO)-[:-60]?[a])<)}\\
    \cmpd{Pseudopelletierine} & \cmpd{Scopine}\\
  \end{tabular}
\end{center}

[3.3.1]-пропелланы~\cmpd{Propellanes331}

\begin{center}
  \begin{tabular}{c}
  \chemfig{[:-30]X*6(-?[a](-[:180]-[:120]Y-[:+60]-[:0]?[a])--Y---)} \\
  \cmpd{Propellanes331} \\
\end{tabular}
\end{center}
