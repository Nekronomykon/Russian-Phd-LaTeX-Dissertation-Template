...
\begin{figure}
  \centerfloat{
    \begin{tabular}{cc}
      \multicolumn{2}{c}{\ChemPicture{[,0.75]?[a]<[:-30,1.5]-[:+30,,,,line width=\boldbondwidth](>[:+120]-[:-120](-[:-150]?[a])(-[:-30]-[:+30,1.25]?[b]))-[:-+30,,,,line width=\boldbondwidth]?[b,{<}]}} \\
...
\begin{tabular}{c|c}
\multicolumn{2}{c}{
\ChemPicture{[,0.75]X?[a]<[:-30,1.5]-[:+30,,,,line width=\boldbondwidth](>[:+120]Z-[:-120](-[:-150]?[a])(-[:-30]-[:+30,1.25]Y?[b]))-[:-+30,,,,line width=\boldbondwidth]?[b,{<}]} 
}
\\
\multicolumn{2}{c}{\BB{}~(\TT{})} \\
\midrule
