...
\begin{figure}
  ...
  (II)~Трёхкоординированные
  
  \vspace{\medskipamount}
  \begin{tabular}{c|c|c|c|cc}
    \chemfig{B(<[:-120])(<:[:-60])-[:+90]} & \chemfig{C(<[:-120])(<:[:-60])(-[:+150]R)-[:+30]} &   \chemfig{N(<[:-120])(<:[:-60])-[:+30]} & \chemfig{Si(<[:-120])(<:[:-60])(-[:+150]R)-[:+30]} &  \chemfig{P(<[:-120])(<:[:-60])-[:+30]} & \chemfig{P(<[:-120])(<:[:-60])(=[:+150]O)-[:+30]}
  \end{tabular}
  \vspace{\bigskipamount}
  \caption{\label{fig:Atom:Types}А вот как бы назвать эту картинку получше?}
\end{figure}
