...
\pgfplotsset{width=11.5cm,compat=1.16}
...
\pgfplotstableset{%
  ...
  columns/Tau/.style={int detect,column type=r,column name={$\tau$}},
  columns/Etot/.style={fixed,fixed zerofill,precision=6,column name={$E_{tot}$}},
  columns/Emin/.style={fixed,fixed zerofill,precision=6,
    column name={$E_0$},
  },
  columns/Erel/.style={fixed,fixed zerofill,precision=2,%showpos,
