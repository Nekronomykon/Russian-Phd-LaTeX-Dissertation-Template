...
\newcommand{\DrawCorrFrame}[2]{%
  \begin{scope}[black]%
    \begin{scope}[thick,solid]%
      \draw[dotted](0.5,0.) -- (4.5,0.);        % X axis
      \draw(0.5,#1 - 0.5) -- (0.5,#2 + 0.5);    % Y axis
      \draw(4.5,#1 - 0.5) -- (4.5,#2 + 0.5);    % Y axis
      \foreach \y in {#1,...,#2} %
      { %
        \draw(0.45,\y) -- (0.5,\y);%
    ...
    \foreach \x in {1,...,4}  %
    { %
      \draw[ultra thin] (\x + 0.5,#1 - 0.25)  -- (\x  + 0.5, #2 + 0.25);%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
\newcommand{\DrawFourCorrelation}[4]{%
  \begin{scope}[ultra thick,solid]%
    \draw(0.875, #1) -- (1.125, #1); % #1
    \draw(1.875, #2) -- (2.125, #2); % #2
    \draw(2.875, #3) -- (3.125, #3); % #3
    \draw(3.875, #4) -- (4.125, #4); % #4 
  \end{scope}%
  % bounding lines
  \begin{scope}%
    \draw(1.875, #2) -- (1.125, #1) -- (2.875, #3); % #2 -- #1 -- #3
    \draw(2.125, #2) -- (3.875, #4) -- (3.125, #3); % #2 -- #4 -- #3
  \end{scope}%
}%
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
